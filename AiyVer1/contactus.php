			...
			<div id="bodyContBg" ></div>
				...
				<script type="text/javascript">
					...
					<script type="text/javascript">
						...
						<div style="position:relative;width:60%;"><span style="font-size:150%;font-style:italic;">Contact Info:</span>
						<br/>Email:info@adityaiyengaryoga.com<br/>Mobile:+91-9845615277<br/>
						Location:1st main road,Prashanth Nagar, Nagarbhavi main road, Vijayanagar, Bengaluru- 560040
						<br/><br/></div>
						Kindly enter your email and send your suggestions/queries.<br/>
						Your Email:<br/>
						<input type="textbox"  id="sugMail" style="width:35%;"/><br/><br/>
						Suggestion/query:<br/>
						<textarea id="sugBody" style="width:60%;"></textarea>
						<br/><div style="position:relative;left:45.5%;width:15%;" id="sugBut" class="defBut"><span>Suggest</span></div>																
					</div>
					<script type="text/javascript">
						$("#sugBut").click(function(){suggest()});
						$("#contactInfo").css({"min-height":screenComparePercentHeight(20)});
						$("#sugMail").css({"height":screenComparePercentHeight(5)});
						$("#sugBody").css({"height":screenComparePercentHeight(15)});
						$("#sugBut").css({"height":screenComparePercentHeight(5)});
					</script>
				</div>
